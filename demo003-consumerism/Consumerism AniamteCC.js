...
(lib.CachedBmp_8copy2 = function() {
	this.initialize(img.CachedBmp_8copy2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,4044,2289);


(lib.CachedBmp_8copy = function() {
	this.initialize(img.CachedBmp_8copy);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,4044,2289);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(122).to({_off:false},0).to({_off:true},48).wait(79));

	// IMG3
	this.instance_13 = new lib.IMG03("synched",0);
	this.instance_13.setTransform(960,540);
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(98).to({_off:false},0).to({_off:true},51).wait(100));

	// IMG2
	this.instance_14 = new lib.IMG02("synched",0);
	this.instance_14.setTransform(960,540);
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(74).to({_off:false},0).to({_off:true},50).wait(125));

	// IMG1
	this.instance_15 = new lib.IMG01("synched",0);
	this.instance_15.setTransform(960,1620);
	this.instance_15._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(49).to({_off:false},0).to({_off:true},50).wait(150));
...
lib.properties = {
	...
	manifest: [
		...
		{src:"images/CachedBmp_8copy2.png", id:"CachedBmp_8copy2"},
		{src:"images/CachedBmp_8copy.png", id:"CachedBmp_8copy"},
